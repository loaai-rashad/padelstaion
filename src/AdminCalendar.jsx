...
export default function MyCalendar() {
  ...
  const hasConflict = (newEvent, existingEvents) => {
    ...
    return existingEvents.some((existingEvent) => {
      ...
      return (
        ...
        (newStart.isSame(existingStart) && newEnd.isSame(existingEnd)) // Handle exact time slot overlap
      );
    });
  };
  ...
  const addNewEvent = (newEvent) => {
    ...
    if (hasOverlappingEvent) {
      ...
      alert("Conflicting reservation found. Please choose a different time slot.");
